...
const ROW_WHITE_REGUARD = 7;
const ROW_WHITE_VANGUARD = 0;
const ROW_BLACK_REGUARD = 6;
const ROW_BLACK_VANGUARD = 1;
...
function isWhiteReugard(rowNumber) {
    if (rowNumber === ROW_WHITE_REGUARD) {
        return true;
    } else {
        return false;
    }
...
function isBlackReugard(rowNumber) {
    if (rowNumber === ROW_BLACK_REGUARD) {
        return true;
    } else {
        return false;
    }
...
function isWhiteVanguard(rowNumber) {
    if (rowNumber === ROW_WHITE_VANGUARD) {
        return true;
    } else {
        return false;
    }
...
function isBlackVanguard(rowNumber) {
    if (rowNumber === ROW_BLACK_VANGUARD) {
        return true;
    } else {
        return false;
    }
